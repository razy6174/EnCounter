...
- [開発技術](#開発技術)
  - [活用した技術](#活用した技術)
  - [独自技術](#独自技術)
- [開発の流れ（生成AIの活用について）](#開発の流れ生成aiの活用について)
  - [開発プロセス全体図](#開発プロセス全体図)
  - [開発ドキュメント](#開発ドキュメント)
...
本プロジェクトでは、**企画から実装まで生成AIを全面的に活用**しました。以下に開発プロセスとAI活用方法を時系列で記載します。
...
#### 3. **人間による品質管理**
すべてのAI生成コード・ドキュメントは、**必ず人間がレビュー・修正**を実施。

**ロジック実装における人間の役割:**
- **実装前**: 各フェーズで具体的な要件定義を作成、AIに指示
- **実装中**: AIが生成したコードのレビュー・修正
- **実装後**: 実機でのデバッグ（Logcat確認）、動作検証
- **エラー対応**: エラー原因の調査・特定（一部AI支援）、修正方針の決定

→ **AIはコード生成の効率化ツール、最終的な品質保証は人間が担当**
