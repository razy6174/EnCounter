...
<div align="center">
  ...
  **「その場所、その瞬間、その気分」を共有する、一期一会のデジタルすれちがい通信**
  ...
  [![スマプロハッカソン 2026](https://img.shields.io/badge/スマプロハッカソン%202026-最優秀賞-gold?style=for-the-badge&logo=trophy)](https://www.smartphone-programming.com/)

  ## 🎉 スマプロハッカソン 2026 🎉
  ### **🏆 最優秀賞 受賞**
  **⚡ ハッカソン開催日程：2026/02/05 〜 2026/02/06**
...
> **En**（縁 / えん）+ **Encounter**（遭遇・出会い）= **EnCounter**
> 
...
EnCounterは、プロフィール設定からマッチング、チャットまでの一連の流れがシームレスに繋がっています。
...
BLE通信の挙動を説明した図です。ユーザーIDを常に発信し、それを別端末が検知します。

#### **マッチング時の通信フロー**

<div align="center">
<img src="assets/images/マッチング時の通信.PNG" width="700" alt="マッチング時の通信">
</div>

BLE検知からFirebase照会、通知までのリアルタイム処理フローを示しています。
