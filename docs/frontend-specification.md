...
- [画面構成](#画面構成)
  - [画面遷移フロー](#画面遷移フロー)
  - [1. SplashScreen - スプラッシュ画面](#1-splashscreen---スプラッシュ画面)
  - [2. ProfileSetupScreen - プロフィール設定画面](#2-profilesetupscreen---プロフィール設定画面)
  - [3. TagSelectionScreen - タグ選択画面](#3-tagselectionscreen---タグ選択画面)
  - [4. RadarScreen - レーダー画面（メイン）](#4-radarscreen---レーダー画面メイン)
  - [5. MatchListScreen - すれちがい図鑑画面](#5-matchlistscreen---すれちがい図鑑画面)
  - [6. UserDetailScreen - ユーザー詳細画面](#6-userdetailscreen---ユーザー詳細画面)
  - [7. ChatScreen - チャット画面](#7-chatscreen---チャット画面)
  - [8. SettingsScreen - 設定画面](#8-settingsscreen---設定画面)
  - [9. ProfileEditScreen - プロフィール編集画面](#9-profileeditscreen---プロフィール編集画面)
  - [10. HelpScreen - ヘルプ画面](#10-helpscreen---ヘルプ画面)
- [ルーティング構成](#ルーティング構成)
  - [ルート定義](#ルート定義)
  - [Screen定義](#screen定義)
  - [ViewModel共有（ProfileFlow）](#viewmodel共有profileflow)
- [デザインシステム](#デザインシステム)
  - [カラーパレット](#カラーパレット)
  - [テーマ設定](#テーマ設定)
  - [タイポグラフィ](#タイポグラフィ)
- [コンポーネント設計パターン](#コンポーネント設計パターン)
  - [Screen/Content分離パターン](#screencontent分離パターン)
  - [開発分担ルール](#開発分担ルール)
- [状態管理](#状態管理)
  - [StateFlow + collectAsState](#stateflow--collectasstate)
  - [UiState vs UiEvent](#uistate-vs-uievent)
- [ユーティリティ](#ユーティリティ)
...
- [スクリーンショット](#スクリーンショット)
  - [スプラッシュ画面](#スプラッシュ画面)
  - [プロフィール設定](#プロフィール設定)
  - [レーダー画面（メイン）](#レーダー画面メイン)
  - [すれちがい履歴・ユーザー詳細](#すれちがい履歴ユーザー詳細)
  - [チャット画面](#チャット画面)
  - [設定・プロフィール編集](#設定プロフィール編集)
  - [ヘルプ画面](#ヘルプ画面)
- [実装例集](#実装例集)
  - [RadarScreen - レーダーアニメーション](#radarscreen---レーダーアニメーション)
  - [ProfileSetupScreen - フローティングロゴ](#profilesetupscreen---フローティングロゴ)
  - [UserDetailScreen - RPG吹き出し](#userdetailscreen---rpg吹き出し)
  - [ChatScreen - キーボード追従スクロール](#chatscreen---キーボード追従スクロール)
- [今後の拡張予定](#今後の拡張予定)
- [関連ドキュメント](#関連ドキュメント)
